 ...
 */
public class FragmentGraficaFinanzas extends Fragment {

    View view;

    private static final String NO_SELECTION_TXT = "Toque una barra.";
    private XYPlot plot;
    ...
    Number[] series1Numbers10 = {1,2,2,3,4,5,4,6,2,7.5};
    Number[] data;
    String [] series = {"1","lun","2","mar","3","mie","4","jue","5","vie","6","sab","7","dom"};
    Number[] series2Numbers10 = {4,6};
    /*
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_grafica_finanzas, container,false);

        Bundle bundle = getArguments();
        float[] datos = bundle.getFloatArray("datos");
        data = new Number[datos.length];
        ...
        formatter1 = new MyBarFormatter(Color.argb(200,70, 130, 180), Color.LTGRAY);
        formatter2 = new MyBarFormatter(Color.argb(200, 100, 100, 150), Color.LTGRAY);
        selectionFormatter = new MyBarFormatter(Color.argb(200, 0, 128, 128), Color.WHITE);
        ...
        plot.getGraphWidget().setGridPadding(30,7, 30, 0);
        ...
        plot.setDomainValueFormat(new DateFormat() {
            @Override
    ...
    private void updatePlot() {
        ...
        series1 = new SimpleXYSeries(Arrays.asList(series1Numbers), SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, "Ingresos");
